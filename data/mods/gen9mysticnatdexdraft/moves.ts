...
export const Moves: import('../../../sim/dex-moves').MoveDataTable = {
	...
	ragefist: {
		...
		flags: { contact: 1, protect: 1, mirror: 1, punch: 1 },
		secondary: null,
		desc: "Power is equal to 50+(X*50), where X is the total number of times the user has been hit by a damaging attack during the battle, even if the user did not lose HP from the attack. X cannot be greater than 6 and does reset upon switching out or fainting. Each hit of a multi-hit attack is counted, but confusion damage is not counted.",
		shortDesc: "+50 power for each time user was hit. Max 6 hits. Resets on switch.",
		target: "normal",
		type: "Ghost",
	},
	ragepowder: {
